...
var GameStart = function(){
	...
	/**************获取游戏图片并缓存*************/
	// 得到飞机图片
	this.plane_img = this.getImg('/images/feiji/myplane2.png');
	// 得到背景图片
	this.bg_img = [this.getImg('/images/feiji/bj01.jpg'),
		this.getImg('/images/feiji/bj02.jpg'),
		this.getImg('/images/feiji/bj03.jpg'),
		this.getImg('/images/feiji/bj04.jpg'),
		this.getImg('/images/feiji/bj05.jpg')];
	// 得到敌机图片
	this.enemy_img = [this.getImg('/images/feiji/dj10.png'),
		this.getImg('/images/feiji/dj6.png'),
		this.getImg('/images/feiji/dj1.png')];
	// 得到我军子弹图片
	this.bullet_img1 = this.getImg('/images/feiji/bullet2.png');
	// 得到爆炸图片
	this.bomb_img = [this.getImg('/images/feiji/b11.gif'),
		this.getImg('/images/feiji/b10.gif'),
		this.getImg('/images/feiji/b9.gif'),
		this.getImg('/images/feiji/b8.gif'),
		this.getImg('/images/feiji/b7.gif'),
		this.getImg('/images/feiji/b6.gif'),
		this.getImg('/images/feiji/b5.gif'),
		this.getImg('/images/feiji/b4.gif'),
		this.getImg('/images/feiji/b3.gif'),
		this.getImg('/images/feiji/b2.gif'),
		this.getImg('/images/feiji/b1.gif')];
	// 得到HP图片
	this.HP_img4 = this.getImg('/images/feiji/img_HP.png');
	// 得到数字图片
	this.num_img = [this.getImg('/images/feiji/0.png'),
		this.getImg('/images/feiji/1.png'),
		this.getImg('/images/feiji/2.png'),
		this.getImg('/images/feiji/3.png'),
		this.getImg('/images/feiji/4.png'),
		this.getImg('/images/feiji/5.png'),
		this.getImg('/images/feiji/6.png'),
		this.getImg('/images/feiji/7.png'),
		this.getImg('/images/feiji/8.png'),
		this.getImg('/images/feiji/9.png')];
		
	/**************获取游戏音频并缓存*************/
	this.btToEp_audio = this.getAudio('/vidao/zd.mp3');//子弹打击敌机声音
